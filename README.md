...
/* =============================================================
   AP Gov — U.S. Constitution Flashcards (DATA ONLY)
   Paste this array into your app to replace the existing CARDS.
   Each item has: { q, a, exp }
   Answers are written in full sentences; explanations are
   student-friendly, emphasizing meaning, examples, and why it matters.
   ============================================================= */
